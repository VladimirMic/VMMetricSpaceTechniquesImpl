...
//    public static final float[] THRESHOLDS_P_CUM = new float[]{0.91f, 0.92f, 0.93f, 0.94f, 0.95f, 0.96f, 0.97f, 0.98f, 0.99f, 1};
    ...
    private double evaluateIDimOfSketches() {
        ...
        while (i < numberOfDists) {
            ...
            Comparable id1 = searchSpaceOfSketches.getIDOfObject(sk1);
            Comparable id2 = searchSpaceOfSketches.getIDOfObject(sk2);
            if (id1.equals(id2)) {
                continue;
            }
            long[] sk1Data = searchSpaceOfSketches.getDataOfObject(sk1);
            long[] sk2Data = searchSpaceOfSketches.getDataOfObject(sk2);

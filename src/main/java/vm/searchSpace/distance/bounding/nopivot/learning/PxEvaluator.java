package vm.searchSpace.distance.bounding.nopivot.learning;
...
public class PxEvaluator {
    ...
    protected PxEvaluator(Dataset fullDataset, Dataset<long[]> sketchesDataset, int objCount, int sketchLength, float distInterval, int minNumberOfExampleForBitToCount) {
        ...
        sketches = ToolsSpaceDomain.getObjectsAsIdDataMap(sketchesDataset);
    ...
    public SortedMap<Float, Float> evaluateProbabilities(float maxDist, int distCount) {
        try {
            ...
            for (int i = 0; i < distCount; i++) {
                ...
                Comparable o1ID = fullSearchSpace.getIDOfObject(o1);
                Comparable o2ID = fullSearchSpace.getIDOfObject(o2);
                Object o1Data = fullSearchSpace.getDataOfObject(o1);
                Object o2Data = fullSearchSpace.getDataOfObject(o2);

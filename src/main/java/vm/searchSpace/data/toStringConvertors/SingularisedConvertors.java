...
import vm.searchSpace.data.toStringConvertors.impl.IntVectorToStringConvertor;
...
public class SingularisedConvertors {
    ...
    public static final IntVectorToStringConvertor INT_VECTOR_SPACE = new IntVectorToStringConvertor();

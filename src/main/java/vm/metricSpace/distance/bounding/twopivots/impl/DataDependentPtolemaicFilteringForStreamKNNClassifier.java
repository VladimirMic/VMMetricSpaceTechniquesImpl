...
public class DataDependentPtolemaicFilteringForStreamKNNClassifier<T> extends DataDependentPtolemaicFiltering implements PtolemaicFilterForVoronoiPartitioning {
    ...
    private int[] addExtremePivot(int[] ret, Set<Integer> remain) {
        Logger.getLogger(DataDependentPtolemaicFilteringForStreamKNNClassifier.class.getName()).log(Level.INFO, "Deciding best pivot permutation");
        ...
        Logger.getLogger(DataDependentPtolemaicFilteringForStreamKNNClassifier.class.getName()).log(Level.INFO, "Finished deciding best pivot permutation");
        return ret;
    }
